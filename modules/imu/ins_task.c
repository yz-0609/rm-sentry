...
static float INS_send_vision[3];
// 用于获取两次采样之间的时间间隔
...
void INS_Task(void)
{
    ...
    if ((count % 1) == 0)
    {
        ...
        INS_send_vision[0]=INS.Yaw*3.1415926f/180.0f;
        INS_send_vision[1]=INS.Pitch*3.1415926f/180.0f;
        INS_send_vision[2]=INS.Roll*3.1415926f/180.0f;
        VisionSetAltitude(INS_send_vision[0],INS_send_vision[1],INS_send_vision[2]);

        // VisionSetAltitude(INS.Yaw, INS.Pitch, INS.Roll);
        VisionSetAltitudeVel(INS.Gyro[X],INS.Gyro[Y],INS.Gyro[Z]);
    }
