...
typedef struct
{
	...
	ground_robot_position_t GroundRobotPos;                // 0x20B
	rfid_status_t RFIDStatus;                              // 0x209
	projectile_allowance_t ProjectileAllowance;            // 0x208
	sentry_info_t SentryInfo;                              // 0x20D
